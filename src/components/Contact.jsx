...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-padding bg-bg relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] md:w-[1000px] md:h-[1000px] bg-primary/5 rounded-full blur-[120px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="mb-8 md:mb-12 text-center">
          <TextReveal as="h2" className="text-[32px] sm:text-[48px] md:text-[80px] lg:text-[120px] font-display font-bold leading-none mb-2 md:mb-4 uppercase">Let's build</TextReveal>
          <TextReveal as="h2" className="text-[32px] sm:text-[48px] md:text-[80px] lg:text-[120px] font-display font-bold leading-none uppercase [&_.text-reveal-inner]:text-transparent [&_.text-reveal-inner]:bg-clip-text [&_.text-reveal-inner]:bg-gradient-to-r [&_.text-reveal-inner]:from-black [&_.text-reveal-inner]:to-accent">Together.</TextReveal>
        </div>
        ...
        <div className="flex flex-col items-center justify-center mb-16 md:mb-24">
          ...
          <div className="flex flex-col justify-center text-center max-w-2xl mx-auto mb-16">
            <p className="text-text-muted text-base md:text-xl lg:text-[22px] leading-relaxed mb-10">
            ...
            <MagneticButton strength={0.3} className="inline-block mx-auto">
              <a
                ...
                className="inline-flex items-center gap-4 md:gap-6 px-6 md:px-10 lg:px-12 py-3 md:py-4 lg:py-5 rounded-full bg-primary text-white text-base md:text-xl font-display font-bold hover:scale-105 transition-transform group"
              >
                SAY HELLO
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 md:pt-12 border-t border-black/5 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start relative">
            ...
            {activePlatform && (
              <div className="absolute bottom-full left-1/2 md:left-0 -translate-x-1/2 md:translate-x-0 mb-8 w-[calc(100vw-2rem)] sm:w-[320px] md:w-[360px] origin-bottom md:origin-bottom-left animate-in zoom-in-50 fade-in duration-300 z-50">
          ...
          <div className="flex flex-wrap justify-center md:justify-end gap-4 sm:gap-8 md:gap-12 text-[10px] text-text-muted uppercase tracking-[0.3em] font-bold">
